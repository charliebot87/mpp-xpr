// mppx-xpr-network/server — server-side entry point
// Usage: import { xpr, Mppx } from 'mppx-xpr-network/server'
...
// Re-export Mppx so consumers can do: import { Mppx, xpr } from 'mppx-xpr-network/server'
