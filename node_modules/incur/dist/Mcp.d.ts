...
export declare function callTool(tool: ToolEntry, params: Record<string, unknown>, extra?: {
    _meta?: {
...
export declare function collectTools(commands: Map<string, any>, prefix: string[]): ToolEntry[];
