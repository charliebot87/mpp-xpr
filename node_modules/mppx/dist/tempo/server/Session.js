...
export function session(p) {
    const parameters = p;
    const { amount, channelStateTtl = 60_000, currency = defaults.resolveCurrency(parameters), decimals = defaults.decimals, store: rawStore = Store.memory(), suggestedDeposit, unitType, waitForConfirmation = true, } = parameters;
